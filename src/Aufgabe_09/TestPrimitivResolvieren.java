...
public class TestPrimitivResolvieren {
...
//		knf.add(klausel4);
	...
	public void testKNF1() {
		...
		assertEquals(new HashSet<Klausel>(),Resolution.resolvierenPrimitiv(this.knf));
	}
	...
	public void testKNF2() {
		...
		assertEquals(knfTest,Resolution.resolvierenPrimitiv(this.knf));
	}
